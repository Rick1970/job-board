...
function displayPostings(i) {
  var sentence = "<div class='back-job-postings col-md-4'><div class='panel'><div class='panel-heading'><h3 class='panel-title'>" + backPositionArray[i].title + "</h3></div><div class='panel-body'><p><strong>Company: </strong>" + backPositionArray[i].company + "</p><p><strong>Description: </strong>" + backPositionArray[i].description + "</p><p>";
