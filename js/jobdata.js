...
var backPositionArray = [
  ...
  new BackPosition ("Front-End Developer", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", "The Pin and Cushion Donut Company", "Seattle, WA", ["HTML", "CSS", "Javascript"], 6),
  new BackPosition ("Junior Cheeseburger Specialist", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", "The Pin and Cushion Donut Company", "Seattle, WA", ["Android", "Java"], 7),
  ...
  new BackPosition ("Senior Mobile Developer", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", "Microsoft Towels and Bedding", "Seattle, WA", ["iOS", "Android", "Java", "SQL"], 26),
  new BackPosition ("Master Yi", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", "Epicurious Coding School", "Seattle, WA", ["HTML", "CSS", "Javascript", "C-Sharp", "SQL"], 27),
